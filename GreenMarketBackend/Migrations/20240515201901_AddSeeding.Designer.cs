...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240515201901_AddSeeding")]
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "f59d3720-3f37-4f60-ac4d-7c867dc66e99",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECK6j0LutiQcFnFtNqbYSzpEmi6SQ10Bj9gxsg2rQ388AFfRA3U2bdaA7xyK3oQpFQ==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 5, 15, 22, 19, 0, 248, DateTimeKind.Local).AddTicks(7356),
                            SecurityStamp = "aff265ba-b72b-4b30-b752-bb6c6942fd04",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 15, 22, 19, 0, 248, DateTimeKind.Local).AddTicks(7638),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 4, 15, 22, 19, 0, 248, DateTimeKind.Local).AddTicks(7642),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 5, 15, 22, 19, 0, 248, DateTimeKind.Local).AddTicks(7648),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 5, 5, 22, 19, 0, 248, DateTimeKind.Local).AddTicks(7650),
