...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240516222816_CreateIdentitySchema")]
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "5ae8e346-1048-4b6c-9718-f618c607d3c4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMQrTlHiGtPdpmNpCoy1G9wDKvTane6MBvmiAbt+BX+WRiu9nUh5aUGxk+aVFOoUCQ==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 5, 17, 0, 28, 15, 165, DateTimeKind.Local).AddTicks(8790),
                            SecurityStamp = "cbb58706-58ec-45b2-ae1b-86f034877e01",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 17, 0, 28, 15, 165, DateTimeKind.Local).AddTicks(9063),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 4, 17, 0, 28, 15, 165, DateTimeKind.Local).AddTicks(9069),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 5, 17, 0, 28, 15, 165, DateTimeKind.Local).AddTicks(9076),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 5, 7, 0, 28, 15, 165, DateTimeKind.Local).AddTicks(9078),
