...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240527182247_ReviewNesto")]
    partial class ReviewNesto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "b7e29788-15b3-43bf-a4f9-7f34b09fa37c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBCoxu374NN4WISnk4uS8BYBA29MaaQVx4PNa9rMZWJOJzugXgDsPhxewMGiw8Bxfw==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 5, 27, 20, 22, 46, 241, DateTimeKind.Local).AddTicks(3629),
                            SecurityStamp = "6460a4bb-8ea2-459a-9675-dd283eaf55f9",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 27, 20, 22, 46, 241, DateTimeKind.Local).AddTicks(3907),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 4, 27, 20, 22, 46, 241, DateTimeKind.Local).AddTicks(3910),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 5, 27, 20, 22, 46, 241, DateTimeKind.Local).AddTicks(3975),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 5, 17, 20, 22, 46, 241, DateTimeKind.Local).AddTicks(3977),
