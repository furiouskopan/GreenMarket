...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240605210249_UpdateCartSchema")]
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "4dca1209-5005-4d06-b956-6333bbc416c1",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJK/Am/EpLHIItFLQPduNWiHrgMPo+fB+Y+Pu3GpO71o4cRQzOJ603R9gwyfCuoD1w==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 6, 5, 23, 2, 48, 623, DateTimeKind.Local).AddTicks(6908),
                            SecurityStamp = "8fc68e9d-bd35-4b8a-b13b-fdad35ea70e4",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 5, 23, 2, 48, 623, DateTimeKind.Local).AddTicks(7212),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 5, 6, 23, 2, 48, 623, DateTimeKind.Local).AddTicks(7223),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 6, 5, 23, 2, 48, 623, DateTimeKind.Local).AddTicks(7230),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 5, 26, 23, 2, 48, 623, DateTimeKind.Local).AddTicks(7233),
