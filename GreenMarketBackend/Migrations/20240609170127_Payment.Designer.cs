...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240609170127_Payment")]
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "9127f4c1-a2ec-43b3-8036-a6dc1a4612dc",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKzWe+e4Fyp+3ewe5KjOZuLaD+T1PcItbleUanJzz332gZSH0sXn3SGLMixJjz41wg==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 6, 9, 19, 1, 25, 814, DateTimeKind.Local).AddTicks(446),
                            SecurityStamp = "5b5fd63d-c218-4268-ac2a-a7763cfe1b68",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 9, 19, 1, 25, 814, DateTimeKind.Local).AddTicks(750),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 5, 10, 19, 1, 25, 814, DateTimeKind.Local).AddTicks(754),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 6, 9, 19, 1, 25, 814, DateTimeKind.Local).AddTicks(762),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 5, 30, 19, 1, 25, 814, DateTimeKind.Local).AddTicks(764),
