...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240617210244_IndividualChats")]
    partial class IndividualChats
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "22acc6e0-f7c4-4c9d-ac78-1a66c883c3da",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECpFdMDyI9qkUw2HMRCynjweZklGjQrBrRs+WmNaxiaFJ7+m6+mC+CuOcoxfK5+aAA==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 6, 17, 23, 2, 43, 13, DateTimeKind.Local).AddTicks(7045),
                            SecurityStamp = "a3281622-09f6-446e-86a5-0cc1a2a22f3c",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 17, 23, 2, 43, 13, DateTimeKind.Local).AddTicks(7337),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 5, 18, 23, 2, 43, 13, DateTimeKind.Local).AddTicks(7340),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 6, 17, 23, 2, 43, 13, DateTimeKind.Local).AddTicks(7348),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 6, 7, 23, 2, 43, 13, DateTimeKind.Local).AddTicks(7350),
