...
namespace GreenMarketBackend.Migrations
{
    ...
    [Migration("20240831123925_InitialCreate")]
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "Epimenonda",
                            ConcurrencyStamp = "fa60db48-49c6-460d-a9b6-38d50ff5feda",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDXYIGIWpgbFCNM/vekihOHvoZhs2L/tOSCCpykSBKeuxktDZDkAGI1iFVZbRPQBkw==",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTime(2024, 8, 31, 14, 39, 23, 579, DateTimeKind.Local).AddTicks(9737),
                            SecurityStamp = "3c3d6536-03c7-4191-bade-e0bb130a0ab1",
            ...
            modelBuilder.Entity("GreenMarketBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 8, 31, 14, 39, 23, 580, DateTimeKind.Local).AddTicks(29),
                            Description = "Fresh apples from local orchards.",
                            HarvestDate = new DateTime(2024, 8, 1, 14, 39, 23, 580, DateTimeKind.Local).AddTicks(33),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedByUserId = "a1234567-89ab-cdef-0123-456789abcdef",
                            CreatedDate = new DateTime(2024, 8, 31, 14, 39, 23, 580, DateTimeKind.Local).AddTicks(41),
                            Description = "Crunchy carrots perfect for a healthy snack.",
                            HarvestDate = new DateTime(2024, 8, 21, 14, 39, 23, 580, DateTimeKind.Local).AddTicks(43),
